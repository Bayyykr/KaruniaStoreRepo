...
public class diagramkaryawan extends JPanel {
    ...
    private Map<String, Color> employeeColors;
...
//        dataset.addValue(0, "Kehadiran", "Habibi Zayne");
        ...
        try {
            ...
            // Query untuk menghitung kehadiran berdasarkan tanggal unik
            String sql = "SELECT u.nama_user, COUNT(DISTINCT DATE(a.waktu_masuk)) AS total_kehadiran " +
                         "FROM absensi a " +
                         "JOIN user u ON a.norfid = u.norfid " +
                         "WHERE a.waktu_masuk IS NOT NULL AND a.waktu_keluar IS NOT NULL " +
            ...
            while (rs.next()) {
                ...
                int kehadiran = rs.getInt("total_kehadiran");
                dataset.addValue(kehadiran, "Kehadiran", nama);
