...
public class PopUpSmall_TambahKaryawanTidakBolehKosong extends JDialog {
    ...
    private static ArrayList<PopUpSmall_TambahKaryawanTidakBolehKosong> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUpSmall_TambahKaryawanTidakBolehKosong(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Data inputan tidak boleh kosong!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUpSmall_TambahKaryawanTidakBolehKosong() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUpSmall_TambahKaryawanTidakBolehKosong popup = activePopups.get(i);
