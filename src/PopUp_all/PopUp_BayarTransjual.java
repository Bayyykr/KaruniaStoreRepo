...
import SourceCode.PopUp_transbelihapusdatasucces;
import java.awt.*;
...
public class PopUp_BayarTransjual extends JDialog {
    ...
    public PopUp_BayarTransjual(JFrame parent) {
        ...
        warningTextLabel = createTextLabel("Ready To Check Out?", 130, 75, 200, 30, new Font("poopins", Font.BOLD, 18), Color.BLACK);
        warningTextLabel.setVisible(false);
        contentPanel.add(warningTextLabel);

        confirmTextLabel = createTextLabel(
                "<html><center>Make sure everything looks good! Click Confirm to Complete your payment.</center></html>",
