...
public class PopUp_DashboardKaryawanBarangTerlaris extends JDialog {
    ...
    public PopUp_DashboardKaryawanBarangTerlaris() {
        this(null);
    }

    public PopUp_DashboardKaryawanBarangTerlaris(JFrame parent) {
