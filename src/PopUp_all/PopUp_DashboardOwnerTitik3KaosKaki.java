...
public class PopUp_DashboardOwnerTitik3KaosKaki extends JDialog {
    ...
    private String currentCategory = "Kaos Kaki"; 
    private final String SEARCH_ICON_PATH = "/SourceImage/icon/icon_search_hitam.png";

    public PopUp_DashboardOwnerTitik3KaosKaki() {
        this(null);
    }

    public PopUp_DashboardOwnerTitik3KaosKaki(JFrame parent) {
        super(parent, "Detail Stok Kaos Kaki", true);
    ...
    String sql = "SELECT p.id_produk, p.nama_produk, p.size, ks.produk_sisa " +
                ...
                "WHERE p.jenis_produk = 'kaos kaki' AND p.status = 'dijual' " +
    ...
    private void createComponents() {
        ...
        JLabel titleLabel = new JLabel("Detail Stok - Kaos Kaki");
