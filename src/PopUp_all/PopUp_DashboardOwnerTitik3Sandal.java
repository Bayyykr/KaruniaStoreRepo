...
public class PopUp_DashboardOwnerTitik3Sandal extends JDialog {
    ...
    private String currentCategory = "Sandal"; 
    private final String SEARCH_ICON_PATH = "/SourceImage/icon/icon_search_hitam.png";

    public PopUp_DashboardOwnerTitik3Sandal() {
        this(null);
    }

    public PopUp_DashboardOwnerTitik3Sandal(JFrame parent) {
        super(parent, "Detail Stok Sandal", true);
    ...
    String sql = "SELECT p.id_produk, p.nama_produk, p.size, ks.produk_sisa " +
                ...
                "WHERE p.jenis_produk = 'sandal' AND p.status = 'dijual' " +
    ...
    private void createComponents() {
        ...
        JLabel titleLabel = new JLabel("Detail Stok - Sandal");
