...
public class PopUp_DashboardOwnerTitik3Sepatu extends JDialog {
    ...
    public PopUp_DashboardOwnerTitik3Sepatu() {
        this(null);
    }

    public PopUp_DashboardOwnerTitik3Sepatu(JFrame parent) {
        super(parent, "Detail Stok Sepatu", true);
    ...
    String sql = "SELECT p.id_produk, p.nama_produk, p.size, ks.produk_sisa " +
                ...
                "WHERE p.jenis_produk = 'sepatu' AND p.status = 'dijual' " +
    ...
    private void createComponents() {
        ...
        JLabel titleLabel = new JLabel("Detail Stok - Sepatu");
