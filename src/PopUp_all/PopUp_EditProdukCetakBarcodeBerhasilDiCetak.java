...
public class PopUp_EditProdukCetakBarcodeBerhasilDiCetak extends JDialog {
    ...
    private static ArrayList<PopUp_EditProdukCetakBarcodeBerhasilDiCetak> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_EditProdukCetakBarcodeBerhasilDiCetak(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Barcode Berhasil Di Cetak!!", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_EditProdukCetakBarcodeBerhasilDiCetak() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_EditProdukCetakBarcodeBerhasilDiCetak popup = activePopups.get(i);
