...
public class PopUp_EditProdukCetakBarcodeDibatalkan extends JDialog {
    ...
    private static ArrayList<PopUp_EditProdukCetakBarcodeDibatalkan> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_EditProdukCetakBarcodeDibatalkan(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Cetak Barcode Di Batalkan!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_EditProdukCetakBarcodeDibatalkan() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_EditProdukCetakBarcodeDibatalkan popup = activePopups.get(i);
