...
public class PopUp_GajiKAryawanSuksesBayarGaji extends JDialog {
    ...
    private static ArrayList<PopUp_GajiKAryawanSuksesBayarGaji> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_GajiKAryawanSuksesBayarGaji(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Pembayaran gaji telah berhasil!!", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_GajiKAryawanSuksesBayarGaji() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_GajiKAryawanSuksesBayarGaji popup = activePopups.get(i);
