...
public class PopUp_GajiKaryawanBelumMelakukanAbsensiPdaBulanIni extends JDialog {
    ...
    public PopUp_GajiKaryawanBelumMelakukanAbsensiPdaBulanIni(JFrame parent) {
        ...
        warningTextLabel = createTextLabel("Gagal!!", 150, 75, 150, 30, new Font("poopins", Font.BOLD, 21), Color.BLACK);
        warningTextLabel.setVisible(false);
        contentPanel.add(warningTextLabel);

        confirmTextLabel = createTextLabel(
                "<html><center>Karyawan belum melakukan absensi pada bulan ini!!</center></html>",
    ...
    public PopUp_GajiKaryawanBelumMelakukanAbsensiPdaBulanIni() {
