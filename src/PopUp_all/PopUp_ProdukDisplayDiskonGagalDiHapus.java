...
public class PopUp_ProdukDisplayDiskonGagalDiHapus extends JDialog {
    ...
    private static ArrayList<PopUp_ProdukDisplayDiskonGagalDiHapus> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_ProdukDisplayDiskonGagalDiHapus(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Diskon gagal dihapus!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_ProdukDisplayDiskonGagalDiHapus() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_ProdukDisplayDiskonGagalDiHapus popup = activePopups.get(i);
