...
public class PopUp_ProdukDisplayDiskonNamaDiskonSudahAda extends JDialog {
    ...
    private static ArrayList<PopUp_ProdukDisplayDiskonNamaDiskonSudahAda> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_ProdukDisplayDiskonNamaDiskonSudahAda(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Nama Diskon Sudah Ada!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_ProdukDisplayDiskonNamaDiskonSudahAda() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_ProdukDisplayDiskonNamaDiskonSudahAda popup = activePopups.get(i);
