...
public class PopUp_ProdukDisplayDiskonSuksesDiHapus extends JDialog {
    ...
    private static ArrayList<PopUp_ProdukDisplayDiskonSuksesDiHapus> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_ProdukDisplayDiskonSuksesDiHapus(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Diskon berhasil di hapus!!", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_ProdukDisplayDiskonSuksesDiHapus() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_ProdukDisplayDiskonSuksesDiHapus popup = activePopups.get(i);
