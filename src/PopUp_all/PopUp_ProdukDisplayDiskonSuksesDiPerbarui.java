...
public class PopUp_ProdukDisplayDiskonSuksesDiPerbarui extends JDialog {
    ...
    private static ArrayList<PopUp_ProdukDisplayDiskonSuksesDiPerbarui> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_ProdukDisplayDiskonSuksesDiPerbarui(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Diskon berhasil di perbarui!!", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_ProdukDisplayDiskonSuksesDiPerbarui() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_ProdukDisplayDiskonSuksesDiPerbarui popup = activePopups.get(i);
