...
public class PopUp_ProdukDisplayDiskonSuksesDitambahkan extends JDialog {
    ...
    private static ArrayList<PopUp_ProdukDisplayDiskonSuksesDitambahkan> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_ProdukDisplayDiskonSuksesDitambahkan(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Diskon berhasil di tambahkan!!", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_ProdukDisplayDiskonSuksesDitambahkan() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_ProdukDisplayDiskonSuksesDitambahkan popup = activePopups.get(i);
