...
public class PopUp_SmallAturDiskonOwnerAngkaHarus0sampai100 extends JDialog {
    ...
    private static ArrayList<PopUp_SmallAturDiskonOwnerAngkaHarus0sampai100> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallAturDiskonOwnerAngkaHarus0sampai100(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Nilai Diskon Harus 0 - 100!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallAturDiskonOwnerAngkaHarus0sampai100() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallAturDiskonOwnerAngkaHarus0sampai100 popup = activePopups.get(i);
