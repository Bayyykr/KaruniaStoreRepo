...
public class PopUp_SmallDashboardKaryawanFieldJumlahTidakBolehLebihDari11 extends JDialog {
    ...
    private static ArrayList<PopUp_SmallDashboardKaryawanFieldJumlahTidakBolehLebihDari11> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallDashboardKaryawanFieldJumlahTidakBolehLebihDari11(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Jumlah tidak boleh lebih dari 11 digit angka", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallDashboardKaryawanFieldJumlahTidakBolehLebihDari11() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallDashboardKaryawanFieldJumlahTidakBolehLebihDari11 popup = activePopups.get(i);
