...
public class PopUp_SmallDashboardOwnerBiayaOperasionalSuksesDitambahkan extends JDialog {
    ...
    private static ArrayList<PopUp_SmallDashboardOwnerBiayaOperasionalSuksesDitambahkan> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallDashboardOwnerBiayaOperasionalSuksesDitambahkan(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Data Operasional berhasil di tambahkan!!", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallDashboardOwnerBiayaOperasionalSuksesDitambahkan() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallDashboardOwnerBiayaOperasionalSuksesDitambahkan popup = activePopups.get(i);
