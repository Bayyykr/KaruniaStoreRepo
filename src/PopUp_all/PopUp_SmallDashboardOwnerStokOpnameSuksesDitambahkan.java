...
public class PopUp_SmallDashboardOwnerStokOpnameSuksesDitambahkan extends JDialog {
    ...
    private static ArrayList<PopUp_SmallDashboardOwnerStokOpnameSuksesDitambahkan> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallDashboardOwnerStokOpnameSuksesDitambahkan(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Data Stok Opname berhasil di tambahkan!!", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallDashboardOwnerStokOpnameSuksesDitambahkan() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallDashboardOwnerStokOpnameSuksesDitambahkan popup = activePopups.get(i);
