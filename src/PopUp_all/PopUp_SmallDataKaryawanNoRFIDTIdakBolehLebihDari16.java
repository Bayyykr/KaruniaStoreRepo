...
public class PopUp_SmallDataKaryawanNoRFIDTIdakBolehLebihDari16 extends JDialog {
    ...
    private static ArrayList<PopUp_SmallDataKaryawanNoRFIDTIdakBolehLebihDari16> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallDataKaryawanNoRFIDTIdakBolehLebihDari16(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("No RFID maksimal 16 angka", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallDataKaryawanNoRFIDTIdakBolehLebihDari16() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallDataKaryawanNoRFIDTIdakBolehLebihDari16 popup = activePopups.get(i);
