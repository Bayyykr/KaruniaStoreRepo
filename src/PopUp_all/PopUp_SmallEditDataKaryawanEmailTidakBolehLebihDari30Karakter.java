...
public class PopUp_SmallEditDataKaryawanEmailTidakBolehLebihDari30Karakter extends JDialog {
    ...
    private static ArrayList<PopUp_SmallEditDataKaryawanEmailTidakBolehLebihDari30Karakter> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallEditDataKaryawanEmailTidakBolehLebihDari30Karakter(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Email tidak boleh lebih dari 30 karakter", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallEditDataKaryawanEmailTidakBolehLebihDari30Karakter() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallEditDataKaryawanEmailTidakBolehLebihDari30Karakter popup = activePopups.get(i);
