...
public class PopUp_SmallEditDataKaryawanNoTlpHarusBerupaAngka extends JDialog {
    ...
    private static ArrayList<PopUp_SmallEditDataKaryawanNoTlpHarusBerupaAngka> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallEditDataKaryawanNoTlpHarusBerupaAngka(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("No Tlp Harus Berupa Angka!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallEditDataKaryawanNoTlpHarusBerupaAngka() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallEditDataKaryawanNoTlpHarusBerupaAngka popup = activePopups.get(i);
