...
public class PopUp_SmallEditDataKaryawanPAsswordTidakBolehLebihDari13Karakter extends JDialog {
    ...
    private static ArrayList<PopUp_SmallEditDataKaryawanPAsswordTidakBolehLebihDari13Karakter> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallEditDataKaryawanPAsswordTidakBolehLebihDari13Karakter(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Password tidak boleh lebih dari 13 karakter", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallEditDataKaryawanPAsswordTidakBolehLebihDari13Karakter() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallEditDataKaryawanPAsswordTidakBolehLebihDari13Karakter popup = activePopups.get(i);
