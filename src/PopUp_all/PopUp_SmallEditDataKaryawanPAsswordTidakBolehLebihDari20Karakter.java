...
public class PopUp_SmallEditDataKaryawanPAsswordTidakBolehLebihDari20Karakter extends JDialog {
    ...
    private static ArrayList<PopUp_SmallEditDataKaryawanPAsswordTidakBolehLebihDari20Karakter> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallEditDataKaryawanPAsswordTidakBolehLebihDari20Karakter(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Password tidak boleh lebih dari 20 karakter", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallEditDataKaryawanPAsswordTidakBolehLebihDari20Karakter() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallEditDataKaryawanPAsswordTidakBolehLebihDari20Karakter popup = activePopups.get(i);
