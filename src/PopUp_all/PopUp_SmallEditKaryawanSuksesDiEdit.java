...
public class PopUp_SmallEditKaryawanSuksesDiEdit extends JDialog {
    ...
    private static ArrayList<PopUp_SmallEditKaryawanSuksesDiEdit> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallEditKaryawanSuksesDiEdit(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Data Berhasil Di Edit!!", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallEditKaryawanSuksesDiEdit() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallEditKaryawanSuksesDiEdit popup = activePopups.get(i);
