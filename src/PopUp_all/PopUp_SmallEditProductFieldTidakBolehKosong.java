...
public class PopUp_SmallEditProductFieldTidakBolehKosong extends JDialog {
    ...
    private static ArrayList<PopUp_SmallEditProductFieldTidakBolehKosong> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallEditProductFieldTidakBolehKosong(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Field tidak boleh kosong!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallEditProductFieldTidakBolehKosong() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallEditProductFieldTidakBolehKosong popup = activePopups.get(i);
