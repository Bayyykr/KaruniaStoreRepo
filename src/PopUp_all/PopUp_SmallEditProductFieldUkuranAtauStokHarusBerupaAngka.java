...
public class PopUp_SmallEditProductFieldUkuranAtauStokHarusBerupaAngka extends JDialog {
    ...
    private static ArrayList<PopUp_SmallEditProductFieldUkuranAtauStokHarusBerupaAngka> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallEditProductFieldUkuranAtauStokHarusBerupaAngka(JFrame parent) {
    ...
    public PopUp_SmallEditProductFieldUkuranAtauStokHarusBerupaAngka() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallEditProductFieldUkuranAtauStokHarusBerupaAngka popup = activePopups.get(i);
