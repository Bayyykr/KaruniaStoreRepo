...
public class PopUp_SmallEditProductGenerateBarcodeTidakBisa extends JDialog {
    ...
    private static ArrayList<PopUp_SmallEditProductGenerateBarcodeTidakBisa> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallEditProductGenerateBarcodeTidakBisa(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Generate Barcode tidak bisa di rubah!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallEditProductGenerateBarcodeTidakBisa() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallEditProductGenerateBarcodeTidakBisa popup = activePopups.get(i);
