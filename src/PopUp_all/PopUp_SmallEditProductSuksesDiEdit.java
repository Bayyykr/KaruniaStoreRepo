...
public class PopUp_SmallEditProductSuksesDiEdit extends JDialog {
    ...
    private static ArrayList<PopUp_SmallEditProductSuksesDiEdit> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallEditProductSuksesDiEdit(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Data Berhasil Di Perbarui!!", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallEditProductSuksesDiEdit() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallEditProductSuksesDiEdit popup = activePopups.get(i);
