...
public class PopUp_SmallHapusKaryawanSuksesDihapus extends JDialog {
    ...
    private static ArrayList<PopUp_SmallHapusKaryawanSuksesDihapus> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallHapusKaryawanSuksesDihapus(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Data Berhasil Di Hapus!!", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallHapusKaryawanSuksesDihapus() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallHapusKaryawanSuksesDihapus popup = activePopups.get(i);
