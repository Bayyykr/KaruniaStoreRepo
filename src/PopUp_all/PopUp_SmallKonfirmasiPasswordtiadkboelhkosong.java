...
public class PopUp_SmallKonfirmasiPasswordtiadkboelhkosong extends JDialog {
    ...
    private static ArrayList<PopUp_SmallKonfirmasiPasswordtiadkboelhkosong> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallKonfirmasiPasswordtiadkboelhkosong(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Isi konfirmasi password terlebih dahulu!!", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallKonfirmasiPasswordtiadkboelhkosong() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallKonfirmasiPasswordtiadkboelhkosong popup = activePopups.get(i);
