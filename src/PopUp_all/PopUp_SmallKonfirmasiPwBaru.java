...
public class PopUp_SmallKonfirmasiPwBaru extends JDialog {
    ...
    private static ArrayList<PopUp_SmallKonfirmasiPwBaru> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallKonfirmasiPwBaru(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Tolong konfirmasi password terlebih dahulu!!", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallKonfirmasiPwBaru() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallKonfirmasiPwBaru popup = activePopups.get(i);
