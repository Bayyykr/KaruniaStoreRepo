...
public class PopUp_SmallLoginSebagaiKasirBerhasil extends JDialog {
    ...
    private static ArrayList<PopUp_SmallLoginSebagaiKasirBerhasil> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallLoginSebagaiKasirBerhasil(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Masuk Sebagai Kasir", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallLoginSebagaiKasirBerhasil() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallLoginSebagaiKasirBerhasil popup = activePopups.get(i);
