...
public class PopUp_SmallLoginSebagaiOwnerBerhasil extends JDialog {
    ...
    private static ArrayList<PopUp_SmallLoginSebagaiOwnerBerhasil> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallLoginSebagaiOwnerBerhasil(JFrame parent) {
        ...
        // Label Success
        successLabel = createTextLabel("Selamat Datang", 40, 5, 150, 20, new Font("poppins", Font.BOLD, 14), new Color(0, 0, 0));
        contentPanel.add(successLabel);

        // Label deskripsi
        descriptionLabel = createTextLabel("Masuk Sebagai Owner", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallLoginSebagaiOwnerBerhasil() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallLoginSebagaiOwnerBerhasil popup = activePopups.get(i);
