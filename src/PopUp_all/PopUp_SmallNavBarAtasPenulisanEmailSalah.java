...
public class PopUp_SmallNavBarAtasPenulisanEmailSalah extends JDialog {
    ...
    private static ArrayList<PopUp_SmallNavBarAtasPenulisanEmailSalah> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallNavBarAtasPenulisanEmailSalah(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Penulisan email yang benar @gmail.com!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallNavBarAtasPenulisanEmailSalah() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallNavBarAtasPenulisanEmailSalah popup = activePopups.get(i);
