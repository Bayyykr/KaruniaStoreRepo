...
public class PopUp_SmallPasswordSalah extends JDialog {
    ...
    private static ArrayList<PopUp_SmallPasswordSalah> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallPasswordSalah(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Password konfirmasi kamu salah!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallPasswordSalah() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallPasswordSalah popup = activePopups.get(i);
