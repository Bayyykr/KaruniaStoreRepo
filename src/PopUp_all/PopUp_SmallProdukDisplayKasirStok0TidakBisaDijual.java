...
public class PopUp_SmallProdukDisplayKasirStok0TidakBisaDijual extends JDialog {
    ...
    private static ArrayList<PopUp_SmallProdukDisplayKasirStok0TidakBisaDijual> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallProdukDisplayKasirStok0TidakBisaDijual(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Stok produk 0 tidak dapat di jual!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallProdukDisplayKasirStok0TidakBisaDijual() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallProdukDisplayKasirStok0TidakBisaDijual popup = activePopups.get(i);
