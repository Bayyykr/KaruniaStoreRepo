...
public class PopUp_SmallProdukDisplayScanKodeProductDataTidakAda extends JDialog {
    ...
    private static ArrayList<PopUp_SmallProdukDisplayScanKodeProductDataTidakAda> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallProdukDisplayScanKodeProductDataTidakAda(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Data Produk Tidak Tersedia!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallProdukDisplayScanKodeProductDataTidakAda() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallProdukDisplayScanKodeProductDataTidakAda popup = activePopups.get(i);
