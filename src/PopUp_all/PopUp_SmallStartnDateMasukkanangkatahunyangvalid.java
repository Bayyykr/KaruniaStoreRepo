...
public class PopUp_SmallStartnDateMasukkanangkatahunyangvalid extends JDialog {
    ...
    private static ArrayList<PopUp_SmallStartnDateMasukkanangkatahunyangvalid> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallStartnDateMasukkanangkatahunyangvalid(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Masukkan angka tahun yang valid", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallStartnDateMasukkanangkatahunyangvalid() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallStartnDateMasukkanangkatahunyangvalid popup = activePopups.get(i);
