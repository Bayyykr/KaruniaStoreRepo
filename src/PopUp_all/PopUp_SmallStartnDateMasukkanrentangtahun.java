...
public class PopUp_SmallStartnDateMasukkanrentangtahun extends JDialog {
    ...
    private static ArrayList<PopUp_SmallStartnDateMasukkanrentangtahun> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallStartnDateMasukkanrentangtahun(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Masukkan tahun antara 1900-2100", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallStartnDateMasukkanrentangtahun() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallStartnDateMasukkanrentangtahun popup = activePopups.get(i);
