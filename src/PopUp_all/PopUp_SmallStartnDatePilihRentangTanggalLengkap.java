...
public class PopUp_SmallStartnDatePilihRentangTanggalLengkap extends JDialog {
    ...
    private static ArrayList<PopUp_SmallStartnDatePilihRentangTanggalLengkap> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallStartnDatePilihRentangTanggalLengkap(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Silakan pilih rentang tanggal dengan lengkap", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallStartnDatePilihRentangTanggalLengkap() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallStartnDatePilihRentangTanggalLengkap popup = activePopups.get(i);
