...
public class PopUp_SmallSuksesGantiPw extends JDialog {
    ...
    private static ArrayList<PopUp_SmallSuksesGantiPw> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallSuksesGantiPw(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Password telah berhasil di perbarui!!", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallSuksesGantiPw() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallSuksesGantiPw popup = activePopups.get(i);
