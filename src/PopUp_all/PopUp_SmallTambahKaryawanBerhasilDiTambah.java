...
public class PopUp_SmallTambahKaryawanBerhasilDiTambah extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTambahKaryawanBerhasilDiTambah> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTambahKaryawanBerhasilDiTambah(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Data Berhasil Ditambahkan!!", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTambahKaryawanBerhasilDiTambah() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTambahKaryawanBerhasilDiTambah popup = activePopups.get(i);
