...
public class PopUp_SmallTambahKaryawanNoRFIDTidakValid extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTambahKaryawanNoRFIDTidakValid> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTambahKaryawanNoRFIDTidakValid(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("No RFID Tidak Boleh Negatif!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTambahKaryawanNoRFIDTidakValid() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTambahKaryawanNoRFIDTidakValid popup = activePopups.get(i);
