...
public class PopUp_SmallTambahKaryawanNomorTeleponTidakVAlid extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTambahKaryawanNomorTeleponTidakVAlid> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTambahKaryawanNomorTeleponTidakVAlid(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Masukkan 12-13 angka no telepon!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTambahKaryawanNomorTeleponTidakVAlid() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTambahKaryawanNomorTeleponTidakVAlid popup = activePopups.get(i);
