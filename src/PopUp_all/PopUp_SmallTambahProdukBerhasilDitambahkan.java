...
public class PopUp_SmallTambahProdukBerhasilDitambahkan extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTambahProdukBerhasilDitambahkan> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTambahProdukBerhasilDitambahkan(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Produk berhasil di tambahkan", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTambahProdukBerhasilDitambahkan() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTambahProdukBerhasilDitambahkan popup = activePopups.get(i);
