...
public class PopUp_SmallTambahProdukHargaDanStokHarusBerupaAngkaYgValid extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTambahProdukHargaDanStokHarusBerupaAngkaYgValid> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTambahProdukHargaDanStokHarusBerupaAngkaYgValid(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Harga dan stok harus berupa angka", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTambahProdukHargaDanStokHarusBerupaAngkaYgValid() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTambahProdukHargaDanStokHarusBerupaAngkaYgValid popup = activePopups.get(i);
