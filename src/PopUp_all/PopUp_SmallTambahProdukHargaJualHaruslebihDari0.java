...
public class PopUp_SmallTambahProdukHargaJualHaruslebihDari0 extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTambahProdukHargaJualHaruslebihDari0> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTambahProdukHargaJualHaruslebihDari0(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Harga Jual Lebih Dari 0", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTambahProdukHargaJualHaruslebihDari0() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTambahProdukHargaJualHaruslebihDari0 popup = activePopups.get(i);
