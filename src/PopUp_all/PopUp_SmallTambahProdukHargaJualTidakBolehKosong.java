...
public class PopUp_SmallTambahProdukHargaJualTidakBolehKosong extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTambahProdukHargaJualTidakBolehKosong> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTambahProdukHargaJualTidakBolehKosong(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Harga Jual Tidak Boleh Kosong", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTambahProdukHargaJualTidakBolehKosong() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTambahProdukHargaJualTidakBolehKosong popup = activePopups.get(i);
