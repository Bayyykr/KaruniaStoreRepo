...
public class PopUp_SmallTambahProdukMerkTidakBolehHanya0AtauNegatif extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTambahProdukMerkTidakBolehHanya0AtauNegatif> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTambahProdukMerkTidakBolehHanya0AtauNegatif(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Merk Tidak Boleh 0 atau Negatif!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTambahProdukMerkTidakBolehHanya0AtauNegatif() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTambahProdukMerkTidakBolehHanya0AtauNegatif popup = activePopups.get(i);
