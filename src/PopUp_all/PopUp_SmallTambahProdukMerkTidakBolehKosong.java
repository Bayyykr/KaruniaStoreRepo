...
public class PopUp_SmallTambahProdukMerkTidakBolehKosong extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTambahProdukMerkTidakBolehKosong> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTambahProdukMerkTidakBolehKosong(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Merk tidak boleh kosong", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTambahProdukMerkTidakBolehKosong() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTambahProdukMerkTidakBolehKosong popup = activePopups.get(i);
