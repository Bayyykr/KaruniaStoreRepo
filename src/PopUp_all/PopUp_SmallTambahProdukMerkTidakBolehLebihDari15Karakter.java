...
public class PopUp_SmallTambahProdukMerkTidakBolehLebihDari15Karakter extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTambahProdukMerkTidakBolehLebihDari15Karakter> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTambahProdukMerkTidakBolehLebihDari15Karakter(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Merk tidak boleh lebih dari 15 karakter!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTambahProdukMerkTidakBolehLebihDari15Karakter() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTambahProdukMerkTidakBolehLebihDari15Karakter popup = activePopups.get(i);
