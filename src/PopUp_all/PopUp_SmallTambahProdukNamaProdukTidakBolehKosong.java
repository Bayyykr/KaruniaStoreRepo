...
public class PopUp_SmallTambahProdukNamaProdukTidakBolehKosong extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTambahProdukNamaProdukTidakBolehKosong> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTambahProdukNamaProdukTidakBolehKosong(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Nama Produk Tidak Boleh Kosong", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTambahProdukNamaProdukTidakBolehKosong() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTambahProdukNamaProdukTidakBolehKosong popup = activePopups.get(i);
