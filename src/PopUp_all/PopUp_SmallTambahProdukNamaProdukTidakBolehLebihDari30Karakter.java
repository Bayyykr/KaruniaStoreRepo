...
public class PopUp_SmallTambahProdukNamaProdukTidakBolehLebihDari30Karakter extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTambahProdukNamaProdukTidakBolehLebihDari30Karakter> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTambahProdukNamaProdukTidakBolehLebihDari30Karakter(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Nama Produk tidak boleh lebih dari 30 karakter!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTambahProdukNamaProdukTidakBolehLebihDari30Karakter() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTambahProdukNamaProdukTidakBolehLebihDari30Karakter popup = activePopups.get(i);
