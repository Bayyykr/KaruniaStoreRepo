...
public class PopUp_SmallTambahProdukPilihCategoryTerlebihDahulu extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTambahProdukPilihCategoryTerlebihDahulu> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTambahProdukPilihCategoryTerlebihDahulu(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Silakan pilih kategori produk", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTambahProdukPilihCategoryTerlebihDahulu() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTambahProdukPilihCategoryTerlebihDahulu popup = activePopups.get(i);
