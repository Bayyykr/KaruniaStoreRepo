...
public class PopUp_SmallTambahProdukSilakanGenerateaBarcodeTerlebihDahulu extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTambahProdukSilakanGenerateaBarcodeTerlebihDahulu> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTambahProdukSilakanGenerateaBarcodeTerlebihDahulu(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Tolong Cetak Barcode Terlebih Dahulu", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTambahProdukSilakanGenerateaBarcodeTerlebihDahulu() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTambahProdukSilakanGenerateaBarcodeTerlebihDahulu popup = activePopups.get(i);
