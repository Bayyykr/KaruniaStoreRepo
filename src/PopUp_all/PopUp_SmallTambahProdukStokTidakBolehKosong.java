...
public class PopUp_SmallTambahProdukStokTidakBolehKosong extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTambahProdukStokTidakBolehKosong> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTambahProdukStokTidakBolehKosong(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Stok Tidak Boleh Kosong", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTambahProdukStokTidakBolehKosong() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTambahProdukStokTidakBolehKosong popup = activePopups.get(i);
