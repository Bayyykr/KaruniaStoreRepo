...
public class PopUp_SmallTambahProdukStokTidakBolehNegatif extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTambahProdukStokTidakBolehNegatif> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTambahProdukStokTidakBolehNegatif(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Stok tidak boleh negatif", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTambahProdukStokTidakBolehNegatif() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTambahProdukStokTidakBolehNegatif popup = activePopups.get(i);
