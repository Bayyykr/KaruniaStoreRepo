...
public class PopUp_SmallTambahProdukUkuranTidakBoleh0AtauNegatif extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTambahProdukUkuranTidakBoleh0AtauNegatif> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTambahProdukUkuranTidakBoleh0AtauNegatif(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Ukuran tidak boleh 0 atau negatif!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTambahProdukUkuranTidakBoleh0AtauNegatif() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTambahProdukUkuranTidakBoleh0AtauNegatif popup = activePopups.get(i);
