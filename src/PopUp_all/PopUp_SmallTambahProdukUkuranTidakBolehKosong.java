...
public class PopUp_SmallTambahProdukUkuranTidakBolehKosong extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTambahProdukUkuranTidakBolehKosong> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTambahProdukUkuranTidakBolehKosong(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Ukuran Tidak Boleh Kosong", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTambahProdukUkuranTidakBolehKosong() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTambahProdukUkuranTidakBolehKosong popup = activePopups.get(i);
