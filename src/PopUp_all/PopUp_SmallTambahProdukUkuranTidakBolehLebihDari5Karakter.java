...
public class PopUp_SmallTambahProdukUkuranTidakBolehLebihDari5Karakter extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTambahProdukUkuranTidakBolehLebihDari5Karakter> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTambahProdukUkuranTidakBolehLebihDari5Karakter(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Ukuran tidak boleh lebih dari 5 karakter!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTambahProdukUkuranTidakBolehLebihDari5Karakter() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTambahProdukUkuranTidakBolehLebihDari5Karakter popup = activePopups.get(i);
