...
public class PopUp_SmallTransBeliEditQtyDanHargaHarusLebihDari0 extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTransBeliEditQtyDanHargaHarusLebihDari0> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTransBeliEditQtyDanHargaHarusLebihDari0(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Harga atau Qty tidak boleh 0!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTransBeliEditQtyDanHargaHarusLebihDari0() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTransBeliEditQtyDanHargaHarusLebihDari0 popup = activePopups.get(i);
