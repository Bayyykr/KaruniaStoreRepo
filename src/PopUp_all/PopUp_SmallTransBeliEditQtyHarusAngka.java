...
public class PopUp_SmallTransBeliEditQtyHarusAngka extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTransBeliEditQtyHarusAngka> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTransBeliEditQtyHarusAngka(JFrame parent) {
    ...
    public PopUp_SmallTransBeliEditQtyHarusAngka() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTransBeliEditQtyHarusAngka popup = activePopups.get(i);
