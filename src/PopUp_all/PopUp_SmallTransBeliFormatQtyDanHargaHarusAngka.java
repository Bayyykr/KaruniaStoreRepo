...
public class PopUp_SmallTransBeliFormatQtyDanHargaHarusAngka extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTransBeliFormatQtyDanHargaHarusAngka> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTransBeliFormatQtyDanHargaHarusAngka(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Qty Dan Harga Harus Berupa Angka", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTransBeliFormatQtyDanHargaHarusAngka() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTransBeliFormatQtyDanHargaHarusAngka popup = activePopups.get(i);
