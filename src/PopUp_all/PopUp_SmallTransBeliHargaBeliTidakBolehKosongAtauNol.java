...
public class PopUp_SmallTransBeliHargaBeliTidakBolehKosongAtauNol extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTransBeliHargaBeliTidakBolehKosongAtauNol> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTransBeliHargaBeliTidakBolehKosongAtauNol(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Harga Beli Tidak Boleh Kosong/Nol", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTransBeliHargaBeliTidakBolehKosongAtauNol() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTransBeliHargaBeliTidakBolehKosongAtauNol popup = activePopups.get(i);
