...
public class PopUp_SmallTransBeliKodeProdukTidakDitemukanDiDatabase extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTransBeliKodeProdukTidakDitemukanDiDatabase> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTransBeliKodeProdukTidakDitemukanDiDatabase(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Kode Produk Tidak Tersedia", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTransBeliKodeProdukTidakDitemukanDiDatabase() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTransBeliKodeProdukTidakDitemukanDiDatabase popup = activePopups.get(i);
