...
public class PopUp_SmallTransBeliNamaProdukTidakBolehKosong extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTransBeliNamaProdukTidakBolehKosong> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTransBeliNamaProdukTidakBolehKosong(JFrame parent) {
    ...
    public PopUp_SmallTransBeliNamaProdukTidakBolehKosong() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTransBeliNamaProdukTidakBolehKosong popup = activePopups.get(i);
