...
public class PopUp_SmallTransBeliProdukBerhasilDitambahkanKeKeranjang extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTransBeliProdukBerhasilDitambahkanKeKeranjang> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTransBeliProdukBerhasilDitambahkanKeKeranjang(JFrame parent) {
        ...
        // Label Success
        successLabel = createTextLabel("Sukses", 40, 5, 100, 20, new Font("poppins", Font.BOLD, 14), new Color(0, 0, 0));
        contentPanel.add(successLabel);

        // Label deskripsi
        descriptionLabel = createTextLabel("Produk berhasil ditambahkan ke keranjang!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTransBeliProdukBerhasilDitambahkanKeKeranjang() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTransBeliProdukBerhasilDitambahkanKeKeranjang popup = activePopups.get(i);
