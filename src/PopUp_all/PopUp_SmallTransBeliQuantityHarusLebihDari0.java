...
public class PopUp_SmallTransBeliQuantityHarusLebihDari0 extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTransBeliQuantityHarusLebihDari0> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTransBeliQuantityHarusLebihDari0(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Quantity Harus Lebih Dari 0!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTransBeliQuantityHarusLebihDari0() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTransBeliQuantityHarusLebihDari0 popup = activePopups.get(i);
