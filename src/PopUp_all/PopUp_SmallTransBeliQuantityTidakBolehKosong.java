...
public class PopUp_SmallTransBeliQuantityTidakBolehKosong extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTransBeliQuantityTidakBolehKosong> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTransBeliQuantityTidakBolehKosong(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Quantity Tidak Boleh Kosong!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTransBeliQuantityTidakBolehKosong() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTransBeliQuantityTidakBolehKosong popup = activePopups.get(i);
