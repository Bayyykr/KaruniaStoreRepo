...
public class PopUp_SmallTransBeliSizeProdukTidakBolehKosong extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTransBeliSizeProdukTidakBolehKosong> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTransBeliSizeProdukTidakBolehKosong(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Size Produk Tidak Boleh Kosong", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTransBeliSizeProdukTidakBolehKosong() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTransBeliSizeProdukTidakBolehKosong popup = activePopups.get(i);
