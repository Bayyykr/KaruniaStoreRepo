...
public class PopUp_SmallTransBeliSuksesDiSimpan extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTransBeliSuksesDiSimpan> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTransBeliSuksesDiSimpan(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Transaksi Berhasil Di Simpan!!", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTransBeliSuksesDiSimpan() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTransBeliSuksesDiSimpan popup = activePopups.get(i);
