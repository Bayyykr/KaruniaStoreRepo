...
public class PopUp_SmallTransJualBelumAdaBarangYangDImasukkan extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTransJualBelumAdaBarangYangDImasukkan> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTransJualBelumAdaBarangYangDImasukkan(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Belum Ada Barang Yang Masuk!!", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTransJualBelumAdaBarangYangDImasukkan() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTransJualBelumAdaBarangYangDImasukkan popup = activePopups.get(i);
