...
public class PopUp_SmallTransJualCetakStrukDibatalkan extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTransJualCetakStrukDibatalkan> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTransJualCetakStrukDibatalkan(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Cetak di batalkan!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTransJualCetakStrukDibatalkan() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTransJualCetakStrukDibatalkan popup = activePopups.get(i);
