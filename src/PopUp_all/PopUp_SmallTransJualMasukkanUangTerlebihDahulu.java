...
public class PopUp_SmallTransJualMasukkanUangTerlebihDahulu extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTransJualMasukkanUangTerlebihDahulu> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTransJualMasukkanUangTerlebihDahulu(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Masukkan Uang Terlebih Dahulu!!", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTransJualMasukkanUangTerlebihDahulu() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTransJualMasukkanUangTerlebihDahulu popup = activePopups.get(i);
