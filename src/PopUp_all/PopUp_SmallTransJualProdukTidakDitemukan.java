...
public class PopUp_SmallTransJualProdukTidakDitemukan extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTransJualProdukTidakDitemukan> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTransJualProdukTidakDitemukan(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Produk Tidak Ditemukan!!", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTransJualProdukTidakDitemukan() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTransJualProdukTidakDitemukan popup = activePopups.get(i);
