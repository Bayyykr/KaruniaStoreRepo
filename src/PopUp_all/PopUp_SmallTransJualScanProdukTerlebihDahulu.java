...
public class PopUp_SmallTransJualScanProdukTerlebihDahulu extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTransJualScanProdukTerlebihDahulu> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTransJualScanProdukTerlebihDahulu(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Scan Produk Terlebih Dahulu!!", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTransJualScanProdukTerlebihDahulu() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTransJualScanProdukTerlebihDahulu popup = activePopups.get(i);
