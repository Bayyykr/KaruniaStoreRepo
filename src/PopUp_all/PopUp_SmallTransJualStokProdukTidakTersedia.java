...
public class PopUp_SmallTransJualStokProdukTidakTersedia extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTransJualStokProdukTidakTersedia> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTransJualStokProdukTidakTersedia(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Stok produk tidak tersedia!!", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTransJualStokProdukTidakTersedia() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTransJualStokProdukTidakTersedia popup = activePopups.get(i);
