...
public class PopUp_SmallTransJualTambahBarang extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTransJualTambahBarang> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTransJualTambahBarang(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Barang berhasil ditambahkan!!", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTransJualTambahBarang() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTransJualTambahBarang popup = activePopups.get(i);
