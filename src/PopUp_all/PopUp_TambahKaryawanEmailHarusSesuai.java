...
public class PopUp_TambahKaryawanEmailHarusSesuai extends JDialog {
    ...
    private static ArrayList<PopUp_TambahKaryawanEmailHarusSesuai> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_TambahKaryawanEmailHarusSesuai(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Tolong Gunakan Format Email: @gmail.com", 40, 25, 250, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_TambahKaryawanEmailHarusSesuai() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_TambahKaryawanEmailHarusSesuai popup = activePopups.get(i);
