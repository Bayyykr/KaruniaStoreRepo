...
public class PopUp_TambahProdukApakahAndaYakinInginEditProduk extends JDialog {
    ...
    public PopUp_TambahProdukApakahAndaYakinInginEditProduk(JFrame parent) {
        ...
        warningTextLabel = createTextLabel("Apakah anda yakin?", 120, 75, 200, 30, new Font("poopins", Font.BOLD, 18), Color.BLACK);
        warningTextLabel.setVisible(false);
        contentPanel.add(warningTextLabel);

        confirmTextLabel = createTextLabel(
                "<html><center>Apakah anda yakin ingin melakukan perubahan data pada produk ini?</center></html>",
