...
public class PopUp_login_berhasilmasuksebagaikaryawan extends JDialog {
    ...
    public PopUp_login_berhasilmasuksebagaikaryawan(JFrame parent) {
        ...
        warningIconLabel = createLabel("/SourceImage/icon_centang_ijo.png", 205, 10, 80, 80);
        warningIconLabel.setVisible(false);
        contentPanel.add(warningIconLabel);

        warningTextLabel = createTextLabel("Congratulations!!", 150, 75, 150, 30, new Font("poopins", Font.BOLD, 18), Color.BLACK);
        warningTextLabel.setVisible(false);
        contentPanel.add(warningTextLabel);

        confirmTextLabel = createTextLabel(
                "<html><center>You have successfully logged in as an Employee</center></html>",
        ...
        OKButton = createRoundedButton("OK", 160, 190, 130, 30, new Color(0x34C759), Color.WHITE);
    ...
    public PopUp_login_berhasilmasuksebagaikaryawan() {
