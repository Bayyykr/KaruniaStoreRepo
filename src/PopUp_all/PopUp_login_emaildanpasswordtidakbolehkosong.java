...
public class PopUp_login_emaildanpasswordtidakbolehkosong extends JDialog {
    ...
    public PopUp_login_emaildanpasswordtidakbolehkosong(JFrame parent) {
        ...
        confirmTextLabel = createTextLabel(
                "<html><center>The email and password fields should not be blank, please fill in first!!</center></html>",
    ...
    public PopUp_login_emaildanpasswordtidakbolehkosong() {
