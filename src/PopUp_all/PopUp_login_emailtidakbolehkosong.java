...
public class PopUp_login_emailtidakbolehkosong extends JDialog {
    ...
    public PopUp_login_emailtidakbolehkosong(JFrame parent) {
        ...
        confirmTextLabel = createTextLabel(
                "<html><center>The email field should not be blank, please fill it in first!!</center></html>",
    ...
    public PopUp_login_emailtidakbolehkosong() {
