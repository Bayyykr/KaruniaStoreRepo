...
public class PopUp_login_passwordtidakbolehkosong extends JDialog {
    ...
    public PopUp_login_passwordtidakbolehkosong(JFrame parent) {
        ...
        confirmTextLabel = createTextLabel(
                "<html><center>The new password field should not be blank, please fill it in first!!</center></html>",
    ...
    public PopUp_login_passwordtidakbolehkosong() {
