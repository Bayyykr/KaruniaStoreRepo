...
public class PopUp_login_passwordtidakbolehkurangdari5huruf extends JDialog {
    ...
    public PopUp_login_passwordtidakbolehkurangdari5huruf(JFrame parent) {
        ...
        warningTextLabel = createTextLabel("Error!!", 150, 75, 150, 30, new Font("poopins", Font.BOLD, 21), Color.BLACK);
        warningTextLabel.setVisible(false);
        contentPanel.add(warningTextLabel);

        confirmTextLabel = createTextLabel(
                "<html><center>Password should not be less than 5 characters, please re-enter your Password!!</center></html>",
                25, 110, 400, 50, new Font("Poppins", Font.PLAIN, 14), Color.BLACK
        );
        confirmTextLabel.setVisible(false);
        contentPanel.add(confirmTextLabel);

        OKButton = createRoundedButton("OK", 160, 190, 130, 30, new Color(0xFF3B30), Color.WHITE);
    ...
    public PopUp_login_passwordtidakbolehkurangdari5huruf() {
