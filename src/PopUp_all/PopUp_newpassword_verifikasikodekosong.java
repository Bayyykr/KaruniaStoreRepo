...
public class PopUp_newpassword_verifikasikodekosong extends JDialog {
    ...
    public PopUp_newpassword_verifikasikodekosong(JFrame parent) {
        ...
        confirmTextLabel = createTextLabel(
                "<html><center>The verification code field should not be blank, please fill it in first!!</center></html>",
    ...
    public PopUp_newpassword_verifikasikodekosong() {
