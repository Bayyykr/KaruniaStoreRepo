...
public class PopUp_newpassword_verifikasikodesalah extends JDialog {
    ...
    public PopUp_newpassword_verifikasikodesalah(JFrame parent) {
        ...
        confirmTextLabel = createTextLabel(
                "<html><center>The verification code is incorrect, please enter the corresponding code!!</center></html>",
    ...
    public PopUp_newpassword_verifikasikodesalah() {
