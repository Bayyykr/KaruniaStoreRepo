...
public class Popup_LogOutOwner extends JDialog {

    private JComponent glassPane;
    private JFrame parentFrame;
    private static final int RADIUS = 20;
    private JButton cancelButton, LeaveButton;
    ...
    public Popup_LogOutOwner(JFrame parent) {
        ...
        confirmTextLabel = createTextLabel(
                "<html><center>Are you sure you want to exit?</center></html>",
                25, 110, 400, 50, new Font("Poppins", Font.PLAIN, 15), Color.BLACK);
     ...
     public void mouseClicked(MouseEvent e) {
         startCloseAnimation();
         ((Productt) parentFrame).switchBackToLoginPanel();
     }
 });
