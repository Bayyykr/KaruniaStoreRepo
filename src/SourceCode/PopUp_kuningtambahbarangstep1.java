...
public class PopUp_kuningtambahbarangstep1 extends JDialog {
    ...
    public PopUp_kuningtambahbarangstep1(JFrame parent) {
        ...
        // Menggunakan komponen dari PopUp_kuningtambahbarangstep1
        warningIconLabel = createLabel("/SourceImage/icon_seru_kuning.png", 205, 10, 80, 80);
        warningIconLabel.setVisible(false);
        contentPanel.add(warningIconLabel);

        warningTextLabel = createTextLabel("Are you Sure?", 150, 75, 150, 30, new Font("poopins", Font.BOLD, 18), Color.BLACK);
        warningTextLabel.setVisible(false);
        contentPanel.add(warningTextLabel);

        confirmTextLabel = createTextLabel(
                "<html><center>Are you sure to add this item?</center></html>",
                25, 110, 400, 50, new Font("poopins", Font.PLAIN, 14), Color.BLACK);
        confirmTextLabel.setVisible(false);
        contentPanel.add(confirmTextLabel);

        // Menginisialisasi tombol Cancel dan OK
        ...
        OKButton.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                // Tambahkan logika untuk konfirmasi di sini jika diperlukan
                startCloseAnimation();
            }
        });
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            PopUp_kuningtambahbarangstep1 popup = new PopUp_kuningtambahbarangstep1(frame);
            popup.addOKButtonActionListener(e -> System.out.println("OK clicked"));
