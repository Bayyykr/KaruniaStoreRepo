...
public class PopUp_kuningtambahbarangstep2berhasil extends JDialog {
    ...
    public PopUp_kuningtambahbarangstep2berhasil(JFrame parent) {
        ...
        warningTextLabel = createTextLabel("Success!!", 150, 75, 150, 30, new Font("poopins", Font.BOLD, 21), Color.BLACK);
        warningTextLabel.setVisible(false);
        contentPanel.add(warningTextLabel);

        confirmTextLabel = createTextLabel(
                "<html><center>Your item has been successfully added</center></html>",
    ...
    public PopUp_kuningtambahbarangstep2berhasil() {
