...
public class PopUp_transbelicanceltransaksibelistep1 extends JDialog {
    ...
    public PopUp_transbelicanceltransaksibelistep1(JFrame parent) {
        ...
        warningTextLabel = createTextLabel("Are you sure?", 150, 75, 150, 30, new Font("Arial", Font.BOLD, 18), Color.BLACK);
        warningTextLabel.setVisible(false);
        contentPanel.add(warningTextLabel);

        confirmTextLabel = createTextLabel(
                "<html><center>Are you sure you want to cancel this purchase transaction?<br>purchase transaction data?</center></html>",
