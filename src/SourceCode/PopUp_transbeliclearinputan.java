...
public class PopUp_transbeliclearinputan extends JDialog {
    ...
    public PopUp_transbeliclearinputan(JFrame parent) {
        ...
        warningTextLabel = createTextLabel("Warning!", 150, 75, 150, 30, new Font("Arial", Font.BOLD, 18), Color.BLACK);
        warningTextLabel.setVisible(false);
        contentPanel.add(warningTextLabel);

        confirmTextLabel = createTextLabel(
                "<html><center>Are you sure you want to delete all the inputs that have been filled in?<br></center></html>",
        ...
        ClearButton = createRoundedButton("Clear", 250, 190, 130, 30, new Color(0xFF3B30), Color.WHITE);
