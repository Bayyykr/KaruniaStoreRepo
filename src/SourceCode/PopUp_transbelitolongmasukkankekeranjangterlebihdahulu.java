...
public class PopUp_transbelitolongmasukkankekeranjangterlebihdahulu extends JDialog {
    ...
    public PopUp_transbelitolongmasukkankekeranjangterlebihdahulu(JFrame parent) {
        ...
        confirmTextLabel = createTextLabel(
                "<html><center>Please add the item first!!</center></html>",
    ...
    public PopUp_transbelitolongmasukkankekeranjangterlebihdahulu() {
