...
public class PopUp_SmallTransJualProdukBerhasilDiEdit extends JDialog {
    ...
    private static ArrayList<PopUp_SmallTransJualProdukBerhasilDiEdit> activePopups = new ArrayList<>();

    // Untuk animasi kedip
    private float opacity = 0.0f;
    private boolean fadingIn = true;

    public PopUp_SmallTransJualProdukBerhasilDiEdit(JFrame parent) {
        ...
        // Label deskripsi
        descriptionLabel = createTextLabel("Produk Berhasil Diedit!!", 40, 25, 200, 20, new Font("poppins", Font.PLAIN, 11), new Color(90, 90, 90));
    ...
    public PopUp_SmallTransJualProdukBerhasilDiEdit() {
    ...
    private void repositionActivePopups() {
        ...
        for (int i = 0; i < activePopups.size(); i++) {
            PopUp_SmallTransJualProdukBerhasilDiEdit popup = activePopups.get(i);
